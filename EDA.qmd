...
median_bmi<-median(Diabetes$BMI)
range_bmi<-range(Diabetes$BMI)
cat("The median of the BMI of the respondents is", median_bmi,"\n")
...
The univariate analysis of the Income variable shows that the distribution
